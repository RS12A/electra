"""
Django base settings for electra_server project.
...
env = environ.Env(
    DEBUG=(bool, False),
    DJANGO_SECRET_KEY=(str, 'your_KEY_goes_here'),
    DATABASE_URL=(str, 'postgresql://user:pass@localhost:5432/electra_server'),
    CORS_ALLOWED_ORIGINS=(list, []),
    JWT_SECRET_KEY=(str, 'your_KEY_goes_here'),
    JWT_REFRESH_SECRET_KEY=(str, 'your_KEY_goes_here'),
    RSA_PRIVATE_KEY_PATH=(str, str(BASE_DIR / 'keys' / 'private.pem')),
    RSA_PUBLIC_KEY_PATH=(str, str(BASE_DIR / 'keys' / 'public.pem')),
)
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = env('SMTP_FROM', default='Electra Voting <noreply@electra.local>')
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'electra_server.log',
...
UNIVERSITY_NAME = env('UNIVERSITY_NAME', default='Your University Name')
UNIVERSITY_ACRONYM = env('UNIVERSITY_ACRONYM', default='YUN')
...
# Cache Configuration (will be overridden in specific environments)
CACHES = {
    'default': {
